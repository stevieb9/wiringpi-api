...
> **NEXT ACTION:** V5 — rewrite the stale "What changed vs isr-examples.md" appendix in docs/interrupt-examples.md (F6)
> **LAST SESSION:** 2026-06-10 — V4 ✅ (POD/doc fixes across API.pm, docs/pod.md, README: dangling sentence, backticks, lcdPutChar->lcdPutchar, pwm_set_range wording; F5+F9 resolved; podchecker + pod tests pass).
> **ARCHIVE:** See audit-cleanup-archive.md for completed V tasks (V1, V3, V4)
